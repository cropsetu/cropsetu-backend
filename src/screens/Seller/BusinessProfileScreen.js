...
import { COLORS, RADIUS, SHADOWS } from './sellerColors';
    ...
    <SafeAreaView style={s.safe}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 120 }} showsVerticalScrollIndicator={false}>
          ...
          {/* ── Location ── */}
          <View style={s.section}>
            <SectionHeader icon="location-outline" title={t('sellerBizProfile.yourLocation')} color="#0288D1" />
          ...
          {/* ── GST ── */}
          <View style={s.section}>
            <SectionHeader icon="document-text-outline" title={t('sellerBizProfile.gstDetails')} color="#7C3AED" />
          ...
          {/* ── Bank Account ── */}
          <View style={s.section}>
            <SectionHeader icon="card-outline" title={t('sellerBizProfile.bankAccountSection')} color={COLORS.success} />
          ...
          {/* ── KYC Documents ── */}
          <View style={s.section}>
            <SectionHeader icon="shield-checkmark-outline" title={t('sellerBizProfile.kycDocs')} color={COLORS.warning} />
