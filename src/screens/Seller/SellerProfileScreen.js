      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={s.section}>
          ...
          <Row
            ...
            badge={
              user?.gstNumber
                ? { text: t('sellerProfile.verified'), color: COLORS.success }
                : user?.gstOptOut
                ? { text: t('sellerProfile.exempt'), color: COLORS.warning }
                : null
            }
          />
          <Row
            ...
            badge={
              user?.bankAccountNumber
                ? { text: t('sellerProfile.added'), color: COLORS.success }
                : null
            }
          />
          <Row
            ...
            badge={
              user?.kycStatus === 'verified'
                ? { text: t('sellerProfile.verified'), color: COLORS.success }
                : { text: t('sellerProfile.pending'), color: COLORS.warning }
            }
          />
        </View>
        ...
        <View style={s.section}>
          ...
          <Row
            ...
            badge={{ text: t('sellerProfile.active'), color: COLORS.success }}
          />
        </View>
