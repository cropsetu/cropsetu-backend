...
// Ref palette (from Animal-Trade-Hub/constants/colors.ts)
const C = {
  card: '#ffffff',
  foreground: '#1a2e1a',
    ...
    <Modal visible={visible} transparent animationType="none" onRequestClose={onClose}>
      ...
      >
        ...
        <Animated.View style={[s.sheet, { transform: [{ translateY: slideAnim }] }]}>
          ...
          {step === 'phone' && (
            <>
              <Text style={s.title}>Verify with Aadhaar</Text>
          ...
          {step === 'success' && (
            <View style={s.successContainer}>
              ...
              <Text style={s.successTitle}>Aadhaar Verified!</Text>
...
const s = StyleSheet.create({
  ...
  title:        { fontSize: 22, fontWeight: '800', color: C.foreground, marginBottom: 6, fontFamily: 'Inter_800ExtraBold' },
  subtitle:     { fontSize: 14, color: C.mutedForeground, marginBottom: 24, lineHeight: 20, fontFamily: 'Inter_400Regular' },
  label:        { fontSize: 13, fontWeight: '600', color: C.foreground, marginBottom: 8, fontFamily: 'Inter_600SemiBold' },
  inputRow:     { flexDirection: 'row', alignItems: 'center', gap: 8 },
  phonePrefix:  { backgroundColor: C.secondary, borderWidth: 1, borderColor: C.border, borderRadius: 10,
                  paddingHorizontal: 14, paddingVertical: 14, fontSize: 15, color: C.foreground, fontWeight: '600',
                  fontFamily: 'Inter_600SemiBold' },
  input:        { flex: 1, borderWidth: 1.5, borderColor: C.border, borderRadius: 10,
                  paddingHorizontal: 14, paddingVertical: 14, fontSize: 16, color: C.foreground,
                  backgroundColor: C.background, fontFamily: 'Inter_400Regular' },
  btn:          { backgroundColor: C.primary, borderRadius: 12, paddingVertical: 16, alignItems: 'center', marginTop: 20 },
  btnText:      { color: '#fff', fontSize: 16, fontWeight: '700', fontFamily: 'Inter_700Bold' },
  error:        { color: C.destructive, fontSize: 13, marginTop: 8, fontFamily: 'Inter_400Regular' },
  otpRow:       { flexDirection: 'row', gap: 8, justifyContent: 'center', marginBottom: 8 },
  otpBox:       { width: 46, height: 56, borderWidth: 2, borderColor: C.border, borderRadius: 10,
                  alignItems: 'center', justifyContent: 'center', backgroundColor: C.background,
                  fontSize: 22, fontWeight: '700', textAlign: 'center', color: C.foreground,
                  fontFamily: 'Inter_700Bold' },
  otpBoxFilled: { borderColor: C.primary, backgroundColor: C.secondary },
  successContainer: { alignItems: 'center', paddingVertical: 20 },
  successCircle: { width: 100, height: 100, borderRadius: 50, backgroundColor: C.verified,
                   alignItems: 'center', justifyContent: 'center', marginBottom: 20,
                   shadowColor: C.verified, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.4,
                   shadowRadius: 16, elevation: 8 },
  successTitle: { fontSize: 24, fontWeight: '800', color: C.foreground, marginBottom: 8, fontFamily: 'Inter_800ExtraBold' },
  successText:  { fontSize: 15, color: C.mutedForeground, textAlign: 'center', fontFamily: 'Inter_400Regular' },
});
