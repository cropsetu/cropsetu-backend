...
const styles = StyleSheet.create({
  ...
  locationBtn:{ padding: 8, backgroundColor: '#FFFFFF20', borderRadius: 20 },
  ...
  overviewCard: {
    backgroundColor: '#fff', borderRadius: 16, marginHorizontal: 16, marginTop: 12,
  ...
  // Picker modal
  pickerOverlay: { flex: 1, justifyContent: 'flex-end', backgroundColor: '#00000055' },
  pickerSheet: {
    backgroundColor: '#fff', borderTopLeftRadius: 24, borderTopRightRadius: 24,
    paddingBottom: Platform.OS === 'ios' ? 36 : 16,
  },
  pickerHandle: { width: 40, height: 4, borderRadius: 2, backgroundColor: '#E0E0E0', alignSelf: 'center', marginTop: 12, marginBottom: 4 },
